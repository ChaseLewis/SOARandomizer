...
impl CharacterFlags {
    ...
    pub fn can_equip_vyse(&self) -> bool {
        self.0 & Self::VYSE != 0
    }
    pub fn can_equip_aika(&self) -> bool {
        self.0 & Self::AIKA != 0
    }
    pub fn can_equip_fina(&self) -> bool {
        self.0 & Self::FINA != 0
    }
    pub fn can_equip_drachma(&self) -> bool {
        self.0 & Self::DRACHMA != 0
    }
    pub fn can_equip_enrique(&self) -> bool {
        self.0 & Self::ENRIQUE != 0
    }
    pub fn can_equip_gilder(&self) -> bool {
        self.0 & Self::GILDER != 0
    }
...
mod tests {
    ...
    fn test_armor_binary_roundtrip() {
        ...
        let original: Vec<u8> = vec![
            ...
            b'V', b'y', b's', b'e', b'\'', b's', b' ', b'U', b'n', b'i', b'f', b'o', b'r', b'm', 0,
            0, 0, 0x20, // character_flags (Vyse only)
            50,   // sell_percent
            1,    // order1
            2,    // order2
            0,    // padding
            ...
            17, 0, 0x00, 0x0A, // Trait 2-4: None
            0xFF, 0, 0x00, 0x00, 0xFF, 0, 0x00, 0x00, 0xFF, 0, 0x00, 0x00,
        ];
