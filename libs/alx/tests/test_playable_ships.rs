...
fn test_playable_ship_equipment() {
    ...
    let little_jack = &ships[0];
    assert_eq!(little_jack.cannon_ids[0], 400, "Cannon 1 should be Main Cannon");
    assert_eq!(little_jack.cannon_ids[3], 401, "Cannon 4 should be Standard Cannon");
    assert_eq!(little_jack.cannon_ids[4], 430, "Cannon 5 should be Harpoon Cannon");
